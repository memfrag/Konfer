...
/// Which model a language needs Konfer to have fetched, and what the queue does
/// with that.
///
...
struct ModelDownloadQueueTests {
    ...
    @Test("WhisperKit's model folder sits inside Konfer's own models directory")
    func managedModelLandsInKonfersDirectory() {
