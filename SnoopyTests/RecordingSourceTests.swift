...
struct RecordingSourceTests {
    ...
    func recordsApplicationAudio() async throws {
        ...
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("snoopy-tap-\(UUID().uuidString).m4a")
