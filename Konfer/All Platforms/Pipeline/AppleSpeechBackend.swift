...
///
/// Fast, and free of any download Konfer has to manage. It covers 30 locales —
/// German, English, Spanish, French, Italian, Japanese, Korean, Portuguese and
/// Chinese variants — which is why Konfer offers six languages it has no model
...
actor AppleSpeechBackend: TranscriptionBackend {
    ...
    /// Languages Apple's transcriber can actually handle, as far as Konfer is
    ...
    func prepare(
        ...
        // Konfer to cache or clean up afterwards.
