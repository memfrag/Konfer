...
///
/// Konfer diarizes before it transcribes, which means pyannote has already
...
nonisolated extension SpeechRegion {
    ...
    /// `KONFER_VAD_PADDING` overrides it for comparison runs.
    static var padding: TimeInterval {
        ProcessInfo.processInfo.environment["KONFER_VAD_PADDING"]
