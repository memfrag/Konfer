...
/// A model Snoopy downloads and manages itself.
///
...
/// side effect of transcribing, so "what does Snoopy need, and what does it
...
nonisolated enum ManagedModel: String, CaseIterable, Identifiable, Sendable {
    ...
    /// The model a language needs Snoopy to have downloaded, or `nil` when it
